...
//Klient kupuje wszystkie produkty które są na liście z kartą kredytową mając za mało pieniędzy na konice *
        Person janKowalski = new Person("Jan", "Kowalski");
        janKowalski.addAmmountOfMoney(100);
        for (int i = 0; i < 5; i++) {
